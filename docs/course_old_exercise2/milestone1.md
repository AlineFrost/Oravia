...
*4. Free Production*  
Now write 2 sentences about Ana and Kai:
...
<div style="text-align: center; margin: 2rem 0;">
<button onclick="document.getElementById('answer2').style.display='block'; this.style.display='none';" style="background: #4a9cd6; color: white; border: none; padding: 0.75rem 2rem; border-radius: 4px; cursor: pointer;">
    Click to Reveal the Answers
</button>
</div>
...
- Connect ideas, give reasons, and tell simple stories
- Navigate real conversations like the one Ana and Kai just had
- Understand most of Oravia with the help of a vocabulary list

**Congratulations! You have finished the Core Course!**
...
<div style="text-align: center; padding: 2rem 0; background: #e0f2f1; border-radius: 8px; margin-top: 3rem;">
    <p style="font-size: 1.2rem; color: #4a9cd6; margin-bottom: 1rem;">
        🎉 <strong>Core Complete!</strong>
    </p>
    <p style="color: #5a8bb8; margin-bottom: 1.5rem;">
        You are ready for Fluency.
    </p>
</div>
