...
=== "Grammar"
    ...
    Enter *dia* and *hue*! **Dia** is used to indicate an **agent or role**, while **hue** is used to indicate a **recipient**, like this:
    ...
    If you have trouble remembering which is which, notice their sounds are the same as the markers! That is, dia has i + a (actor), and hue has u + e (receiver).
...
function initWarmup() {
        const warmupWords = [
    {id: "num_1", oravia: "tam",  english: "one"},
    {id: "num_2", oravia: "tor",  english: "two"},
    {id: "num_3", oravia: "par",  english: "three"},
    {id: "num_4", oravia: "bale", english: "four"},
    {id: "num_5", oravia: "alui", english: "five"},
    {id: "num_6", oravia: "teva", english: "six"},
    {id: "num_7", oravia: "peri", english: "seven"},
    ];
