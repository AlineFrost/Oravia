...
=== "Grammar"
    ...
    ```
    Nolili a nim faibor a eomio dia. A faiborar a anocari dia. 
    ```
...
=== "Vocabulary"
    ...
    **joldur** = iron (material types + hard)
    ...
    Now try to create a sentence using **YU** words, or 3 if you're up for a challenge!
...
function initWarmup() {
        const warmupWords = [
    {id: "wu_teva_1", oravia: "teva", english: "six"},
    {id: "wu_peri_2", oravia: "peri", english: "seven"},
    {id: "wu_auta_3", oravia: "auta", english: "eight"},
    {id: "wu_tenda_4", oravia: "tenda", english: "nine"},
    {id: "wu_das_5", oravia: "das", english: "ten"},
    {id: "wu_gelna_6", oravia: "gelna", english: "buy"},
    ];
    ...
    function renderSelfAssessment() {
        ...
        html += `<div id="syllable-reminder" style="display:none; margin-top:1.25rem; padding:1rem; background:#eef7fb; border-left:4px solid #4a9cd6; border-radius:6px;"><p style="margin:0 0 0.5rem 0; font-weight:bold; color:#345;">Syllable reminders</p><p style="margin:0.25rem 0;"><strong>auta</strong> = eight; Proto-Indo-European roots, Hindi āṭh, English eight</p><p style="margin:0.25rem 0;"><strong>das</strong> = ten; Portuguese dez, Hindi das</p><p style="margin:0.25rem 0;"><strong>ge</strong> = money, value; Proto-Germanic *geldan, German Geld, Dutch gelden</p></div>`;
