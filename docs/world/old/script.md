...
**mö** (imagine *m* is a symbol for the domain, *o* is another symbol that indicates cluster 1, and the umlaut is the accessory that indicates subcluster 1). This means *moa*. But now you need a clue for which *moa* word (moanih, moalen, moaria?).
