...
=== "Exercise 1"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ---
    ### Round 1
    <div id="matching-game-1" data-lesson="lesson36_words_b" data-round="1"></div>

    ---

    ### Round 2
    <div id="matching-game-2" data-lesson="lesson36_words_b" data-round="2"></div>

    ---

    ### Round 3
    <div id="matching-game-3" data-lesson="lesson36_words_b" data-round="3"></div>

    ---

    ### Round 4
    <div id="matching-game-4" data-lesson="lesson36_words_b" data-round="4"></div>

    ---

    ### Round 5
    <div id="matching-game-5" data-lesson="lesson36_words_b" data-round="5"></div>

    ---

    ### Round 6
    <div id="matching-game-6" data-lesson="lesson36_words_b" data-round="6"></div>

    ---

    ### Round 7
    <div id="matching-game-7" data-lesson="lesson36_words_b" data-round="7"></div>

    ---

    ### Round 8
    <div id="matching-game-8" data-lesson="lesson36_words_b" data-round="8"></div>

    ---

    ### Round 9
    <div id="matching-game-9" data-lesson="lesson36_words_b" data-round="9"></div>
...
<div style="text-align: center; padding: 2rem 0; background: #e0f2f1; border-radius: 8px; margin-top: 3rem;">
    <p style="font-size: 1.2rem; color: #4a9cd6; margin-bottom: 1rem;">
        🎉 <strong>Lesson 37 Complete!</strong>
    </p>
    ...
    <p style="color: #5a8bb8; margin-bottom: 1.5rem;">
        Come back tomorrow for Lesson 38.
    </p>
</div>
