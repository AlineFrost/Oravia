...
=== "Exercise 1"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ---
    ### Round 1
    <div id="matching-game-1" data-lesson="lesson24_words_b" data-round="1"></div>

    ---

    ### Round 2
    <div id="matching-game-2" data-lesson="lesson24_words_b" data-round="2"></div>

    ---

    ### Round 3
    <div id="matching-game-3" data-lesson="lesson24_words_b" data-round="3"></div>

    ---

    ### Round 4
    <div id="matching-game-4" data-lesson="lesson24_words_b" data-round="4"></div>

    ---

    ### Round 5
    <div id="matching-game-5" data-lesson="lesson24_words_b" data-round="5"></div>

    ---

    ### Round 6
    <div id="matching-game-6" data-lesson="lesson24_words_b" data-round="6"></div>

    ---

    ### Round 7
    <div id="matching-game-7" data-lesson="lesson24_words_b" data-round="7"></div>
