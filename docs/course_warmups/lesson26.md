...
=== "Flashcards"
    ...
    <div id="flashcard-container" data-lesson="26"></div>
...
<script>
    ...
    function renderSelfAssessment() {
        ...
        html += '</div>';
        html += `<div id="syllable-reminder" style="display:none; margin-top:1.25rem; padding:1rem; background:#eef7fb; border-left:4px solid #4a9cd6; border-radius:6px;"><p style="margin:0 0 0.5rem 0; font-weight:bold; color:#345;">Syllable reminders</p><p style="margin:0.25rem 0;"><strong>li</strong> = time, calendar; Mandarin li</p><p style="margin:0.25rem 0;"><strong>lite</strong> = small time unit</p><p style="margin:0.25rem 0;"><strong>lil</strong> = again, repetition</p><p style="margin:0.25rem 0;"><strong>lon</strong> = while, simultaneous time</p><p style="margin:0.25rem 0;"><strong>mel</strong> = evening</p></div>`;
