...
=== "Grammar"
    ...
    Now try to create a sentence using **rein**, **elihei**, and **lirul**, or 3 if you're up for a challenge!
...
=== "Vocabulary"
    ...
    <p style="margin: 0;">Possible translation: What do you wear in the morning?</p>
    </div>
    ...
    <p style="margin: 0;">Example answer: En liyar, notor anse (work), nim i yesnou, i yedi yeswol, su i yespai. </p>
    </div>
...
=== "Flashcards"
    ...
    <div id="flashcard-container" data-lesson="36"></div>

<script>
    function initWarmup() {
        const warmupWords = [
    {id: "wu_toului_1", oravia: "toului", english: "tired"},
    {id: "wu_tohdin_2", oravia: "tohdin", english: "sorry"},
    {id: "wu_touvei_3", oravia: "touvei", english: "illness"},
    {id: "wu_toumo_4", oravia: "toumo", english: "hungry"},
    ];
...
<div style="text-align: center; padding: 2rem 0; background: #e0f2f1; border-radius: 8px; margin-top: 3rem;">
        <p style="font-size: 1.2rem; color: #4a9cd6; margin-bottom: 1rem;">
            🎉 <strong>Lesson 36 Complete!</strong>
        </p>
        ...
        <p style="color: #5a8bb8; margin-bottom: 1.5rem;">
            Come back tomorrow for Lesson 37.
        </p>
</div>
