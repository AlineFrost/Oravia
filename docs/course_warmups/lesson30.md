...
=== "Grammar"
    ...
    Ce yun a run a anodu de run fa?
    ...
    <p style="margin: 0;">Example answers: A nim a anodu yunmpou de nim fa. Ga nim fasujal, a nim a yamirli. </p>
    </div>
