...
=== "Grammar"
    ...
    Now try to create a sentence using these new question words, or 3 if you're up for a challenge!
...
=== "Vocabulary"
    ...
    <button onclick="document.getElementById('subcluster5a-answer').style.display='block'; this.style.display='none';" style="background: #4a9cd6; color: white; border: none; padding: 0.75rem 2rem; border-radius: 4px; cursor: pointer;">
        Click to Reveal the Answer
    </button>
    </div>
    
    <div id="subcluster5a-answer" style="display: none; background: #c8e6c9; padding: 1.5rem; border-left: 4px solid #43a047; border-radius: 4px; margin: 2rem 0;">
    ...
    <div style="text-align: center; margin: 2rem 0;">
    <button onclick="document.getElementById('subcluster5b-answer').style.display='block'; this.style.display='none';" style="background: #4a9cd6; color: white; border: none; padding: 0.75rem 2rem; border-radius: 4px; cursor: pointer;">
...
=== "Exercise 2"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.  
    ...
    <div id="matching-game-4" data-lesson="lesson26_exercise2" data-round="1"></div>

    ---

    ### Round 2

    <div id="matching-game-5" data-lesson="lesson26_exercise2" data-round="2"></div>

    ---

    ### Round 3

    <div id="matching-game-6" data-lesson="lesson26_exercise2" data-round="3"></div>

    ---

    ### Round 4

    <div id="matching-game-7" data-lesson="lesson26_exercise2" data-round="4"></div>
...
function initWarmup() {
    ...
    {id: "wu_oines_4", oravia: "oines", english: "joke, funny"},
    {id: "wu_oihi_5", oravia: "oihi", english: "interesting"},
    ...
    function renderSelfAssessment() {
        ...
        html += `<div id="syllable-reminder" style="display:none; margin-top:1.25rem; padding:1rem; background:#eef7fb; border-left:4px solid #4a9cd6; border-radius:6px;"><p style="margin:0 0 0.5rem 0; font-weight:bold; color:#345;">Syllable reminders</p><p style="margin:0.25rem 0;"><strong>be</strong> = travel; Bengali berano</p><p style="margin:0.25rem 0;"><strong>bei</strong> = vehicle; Mandarin bèi</p><p style="margin:0.25rem 0;"><strong>oi</strong> = fun, amuse, entertain</p><p style="margin:0.25rem 0;"><strong>vio</strong> = change, exchange; Latin via</p></div>`;
...
<div style="text-align: center; padding: 2rem 0; background: #e0f2f1; border-radius: 8px; margin-top: 3rem;">
    <p style="font-size: 1.2rem; color: #4a9cd6; margin-bottom: 1rem;">
        🎉 <strong>Lesson 28 Complete!</strong>
    </p>
    ...
    <p style="color: #5a8bb8; margin-bottom: 1.5rem;">
        Come back tomorrow for Lesson 29.
    </p>
</div>
