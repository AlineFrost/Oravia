...
=== "Grammar"
    ...
    ```
    "cedom run fano?" = where is your son?
    ...
    Now try to create a sentence using connectors, or 3 if you're up for a challenge!
...
=== "Flashcards"
    ...
    <div id="flashcard-container" data-lesson="14"></div>
...
<script>
    ...
    function renderSelfAssessment() {
        ...
        html += '</div>';
        html += `<div id="syllable-reminder" style="display:none; margin-top:1.25rem; padding:1rem; background:#eef7fb; border-left:4px solid #4a9cd6; border-radius:6px;"><p style="margin:0 0 0.5rem 0; font-weight:bold; color:#345;">Syllable reminders</p><p style="margin:0.25rem 0;"><strong>bo</strong> = house; Arabic bayt, Hebrew bayit</p><p style="margin:0.25rem 0;"><strong>tal</strong> = door; Persian ṭāq, Hindi tālā</p><p style="margin:0.25rem 0;"><strong>bos</strong> = bathroom</p><p style="margin:0.25rem 0;"><strong>pupi</strong> = falling water sound</p><p style="margin:0.25rem 0;"><strong>lu</strong> = outside, weather; Latin lux, Portuguese luz</p></div>`;
