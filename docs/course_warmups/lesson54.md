...
=== "Vocabulary"
    ...
    *Poh* also means fire, that's why we have *pohpoh* as the word for fire, and *yopoh* as red.
    ...
    <p style="margin: 0;">Example answers: I foum, caora nolili i pas i mo e lei. Mai, haya i pohnen ca nim i mo e mi, caora nim i anidaium.</p>
    </div>
...
=== "Flashcards"
    ...
    <div id="flashcard-container" data-lesson="54"></div>
