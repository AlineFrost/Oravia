...
=== "Grammar"
    ...
    **Tips**
    ...
    <p style="margin: 0 0 0.5rem 0;"> Yesterday, it was I who helped him! </p>
    <p style="margin: 0 0 0.5rem 0;"> Look at the puppy </p>
    <p style="margin: 0 0 0.5rem 0;"> Tell the complete truth / all the truth. </p>
    <p style="margin: 0 0 0.5rem 0;"> "That's good." "It sure is!"" </p>
    <p style="margin: 0 0 0.5rem 0;"> The food has been eaten. </p>
    <p style="margin: 0 0 0.5rem 0;"> The door was kicked by the child.  </p>
    </div>
...
=== "Vocabulary"
    ...
    <p style="margin: 0;"> It's about <strong>comparison</strong>. Just like when we use ga to make comparisons!</p>
    </div>
    ...
    <p style="margin: 0;"> <strong>GAN</strong> is for <strong>ranking</strong>, like above and average. <strong>GAO</strong> is for <strong>a neutral point</strong>, like balance and equal.</p>
    </div>
    ...
    <p style="margin: 0;">Possible translation: What is the number one virtue for you?</p>
    </div>
    ...
    <p style="margin: 0;">Example answer: U nim, elaora su elonor. </p>
    </div>
...
=== "Flashcards"
    ...
    <div id="flashcard-container" data-lesson="45"></div>
