...
=== "Grammar"
    ...
    *NE* does something else very important, too! We use *ne+number* to express the degree of something, and the scale always goes from 0 to 10. For example:
    ...
    nebale yuvabo = 4 out of 10 comfortable = somewhat comfortable
    ...
    Now try to create a sentence using *ne+number*, or 3 if you're up for a challenge!
...
=== "Vocabulary"
    ...
    **winou** = south (geography + down), just like wirel = north (geography + up)  
    ...
    En run bo i dami a leayo dou leinou?
    <textarea style="width: 100%; min-height: 80px; padding: 1rem; border: 2px solid #4a9cd6; border-radius: 8px; font-family: inherit;" placeholder="Write your sentences in Oravia here..."></textarea>
    <div style="text-align: right; margin-top: 0.5rem;">
    <button onclick="(function(btn){
        const prev = btn.parentElement.previousElementSibling; const ta = prev && prev.tagName === 'TEXTAREA' ? prev : prev ? prev.querySelector('textarea') : null;
