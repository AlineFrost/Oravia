...
=== "Grammar"
    ...
    ```
    Iliciu hay i roesau, a roejo a yugai.
    ```
    ...
    ```
    Iliciu a nim a roena hai, eta i ilian e roejo.   
    ```
    
    ```
    Iliciu nim i bontamear, i ilian cadom.   
    ```
    
    ```
    Iliciu nim i moarum, noli a toumo.   
    ```
...
=== "Vocabulary"
    ...
    !!! info "🌍 Sound Connections"
        Ye comes from Turkish yelken (sail/large expanse of fabric).  
        
        Yel means to join, and comes from English yoke.
      
    Here are other words with this root:    
    **aseyel** = kiss (affectionate bodily action + join), just like yeyel = sew (clothing / garment + join)    
    **eleyel** = love (elevated virtues + join)  
    **wilyel** = bridge (human-made geography + join)  
...
=== "Exercise 1"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.  
    ...
    <div id="matching-game-9" data-lesson="lesson34_b" data-round="4"></div>

    ---

    ### Round 5

    <div id="matching-game-10" data-lesson="lesson34_b" data-round="5"></div>
...
<div style="text-align: center; padding: 2rem 0; background: #e0f2f1; border-radius: 8px; margin-top: 3rem;">
    <p style="font-size: 1.2rem; color: #4a9cd6; margin-bottom: 1rem;">
        🎉 <strong>Lesson 35 Complete!</strong>
    </p>
    ...
    <p style="color: #5a8bb8; margin-bottom: 1.5rem;">
        Come back tomorrow for Lesson 36.
    </p>
</div>
