...
<style>
.fc-card { transform-style: preserve-3d; transition: transform 0.45s ease; }
...
=== "Deck 1 — Lessons"
    ...
    Main words taught in the course lessons.

    <div id="fc-deck-container-1" data-deck="1"></div>

=== "Deck 2 — Core"

    Mix of lesson words and new words from the Core vocabulary.

    <div id="fc-deck-container-2" data-deck="2"></div>

=== "Deck 3 — Dictionary"

    Extended vocabulary from the full Oravia dictionary.

    <div id="fc-deck-container-3" data-deck="3"></div>
