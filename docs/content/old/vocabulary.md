  ...
  function render() {
    ...
    filtered.forEach((r, i) => {
      ...
      const subcl = subcl_raw
        ? '<a href="/content/building_blocks/?q=' + subcl_raw + '" style="color:#4a9cd6;text-decoration:none;font-weight:600;" title="Find in Building Blocks">' + subcl_raw.toUpperCase() + ' ↗</a>'
        : '—';
      const root_cell = r.root
        ? '<a href="/content/building_blocks/?q=' + r.root + '" style="color:#5a8bb8;text-decoration:none;" title="Find in Building Blocks">' + r.root + ' ↗</a>'
        : '—';
