...
Today: <textarea style="width: 100%; min-height: 50px; padding: 0.5rem; border: 2px solid #4a9cd6; border-radius: 8px; font-family: inherit;" placeholder="Write here..."></textarea>

Tomorrow: <textarea style="width: 100%; min-height: 50px; padding: 0.5rem; border: 2px solid #4a9cd6; border-radius: 8px; font-family: inherit;" placeholder="Write here..."></textarea>
...
!!! tip "Note"
    Did you notice yourself scanning for certain sounds to find information? For example, looking for **li** words to find out about the timeline? The cluster system can help you scan for information faster and easier. This skill will only get stronger in Fluency.
...
| eodani | meet |
| eodya | invite |
| eompela | parade, party |
| eofa | friend |
| eon | hello |
| eori | please |
| eta | therefore |
| faigel | marry, wedding |
| geldove | sell |
| gerina | money, pay |
| ho | opposite |
| ia | yes |
...
I'm happy that I listen to your stories! You are always amusing!
...
<p style="margin: 0 0 0.5rem 0;">Kai: I will arrive soon. I rented a bicycle yesterday, so I don't need to spend money on the bus.</p>
<p style="margin: 0 0 0.5rem 0;">Ana: What an interesting idea! Can you carry luggage on the bike?</p>
...
<p style="margin: 0 0 0.5rem 0;">Ana: I stay half a month, so I can go to the party with you. Fun! I like meeting new people, and I can rest when I am home.</p>
...
<p style="margin: 0 0 0.5rem 0;">Kai: There is, where the door is. It's a small station.</p>
<p style="margin: 0 0 0.5rem 0;">Ana: Yay!</p>
<p style="margin: 0 0 0.5rem 0;">Kai: Excited! I will tell you a joke while we eat!</p>
<p style="margin: 0 0 0.5rem 0;">Ana: I am happy to listen to your stories. You are always amusing!</p>
<p style="margin: 0 0 0.5rem 0;">Kai: You too! It's fun that you are my friend. Let's go!</p>
