...
<p>You can create new question words by following the same logic: ce + gaolei (what + price, value), ce + ganter (what + number, how many), etc.</p>
</div>
</details>
...
<details class="gr-sec">
<summary>20. Fractional Numbers and Percentages</summary>
<div class="gr-content">
<h4>20.1 Fractions</h4>
...
<h4>20.2 Percentages</h4>
<p>Fractions use the pattern de nen tor, literally &quot;of 100.&quot; this is the same pattern as other fractions.</p>
...
<div class="gr-content">
<h4>22.1 Compounds — the -gu Suffix</h4>
<p>Adding -gu to a modifying word signals they are forming one concept, rather than working as an adjective:</p>
<table>
...
<div class="gr-content">
<p>Causative constructions use verb stacking with pohnen (power, to impose). The one being made to do something takes the e (object) marker as the direct object of pohnen. The caused action follows with i:</p>
<pre>i pohnen ca e [causee]  i [caused action]
...
<p>The strength of imposition scales with context. pohnen implies genuine forcing or imposition. </p>
