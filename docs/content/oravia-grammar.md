...
<p>Because of the markers and block structure, word order is flexible. Most commonly, at the beginning position you may find subjects (SOV / SVO) or sentence framing expressions (e.g., time adverbs, bi speaker comments §30). Other orders are equally accepted with explicit markers.</p>
...
<p>Not all affirmative sentences without subjects default to "I". Some verbs don&#x27;t have a volitional actor and are better understood as impersonal verbs. They may be used to mean &quot;I&quot;, but this is not the default meaning. See below a list of these verbs.<br>
. Existence: dami<br>
. Events and happenings: dateli, eomfel<br>
. Seeming: nomie<br>
. Weather and ambient conditions: lupupi, luval, lufu, lusari, lumbo, lufiva, luyar, luyun, luhue, lubur, lumirwa, luswa, pohem, yolimel, yoyar<br>
. Time: limel, liyar, litam, lipardas, lidastor, liperi, litetan, litegai, litemi, ilteli, lunhem, lunu (when used as impersonal verbs, they mean time passing; see §48)<br>
</p>
...
<h4>14.3 Modifier Use</h4>
<p>When used as adjectives or modifiers, these words have the same experiencer direction as -saba. That is, the complement is the one experiencing the emotion.</p>
<pre>a nim a oihi u run     → I am interesting to you (I have the property of arising interest in you)
a nim a tigim u run    → I am hateful to you
a nim a tohvor u run   → I am frightening to you</pre>
<h4>14.4 Verb List</h4>
